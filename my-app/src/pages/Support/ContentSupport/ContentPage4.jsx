...
const ContentPage4 = () => {
  return (
    <div className="wrapper">
      ...
      <p>
        Mỗi khi sử dụng <strong>Dcoin</strong> để mua hàng khách hàng sẽ nhận
        được <strong>một điểm tích lũy.</strong> Khi đạt đủ số điểm tích lũy,
        tài khoản của quý khách sẽ được tự động nâng cấp thành các cấp VIP tương
        ứng
      </p>
      <br></br>
      <table class="table m-2">
        ...
        <tbody>
          ...
          <tr>
            <td scope="row">
              Số điểm cần để <br></br>đạt được hạng VIP
            </td>
            <td colspan="">
              3.000.000 <br></br> - 49.999.999
            </td>
            <td colspan="">
              50.000.000 <br></br> - 199.999.999
            </td>
      ...
      <div class="p-3 m-3 bg-danger bg-opacity-10 border border-danger border-start-1 rounded-end">
        ...
        Điểm tích lũy là tổng Dcoin dùng để mua hàng được tính từ ngày bắt đầu
        triển khai dịch vụ VIP
