...
const ContentPage8 = () => {
    return (
        ...
        <br></br>
             2. Hoặc bạn có thể click thẳng vào đường link sau: https://divineshop.vn/topup
            <br></br>
            <br></br>
             3. Sau đó, bạn hãy chọn 1 hình thức thanh toán phù hợp với mình. Hiện tại, Divineshop đang có các hình thức thanh toán sau:
            <br></br>   
            <br></br>
